            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-1">datos de la planificacion</h6>
                        <form method="POST" id="comunicados" action="{{route('admin.plans.store')}}" enctype="multipart/form-data">
                            @csrf 
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="mb-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3 text-center">
                                        ...
                                        <div class="input-group flatpickr" id="flatpickr-date">
                                            <input name="date" id="date" type="text" class="form-control" placeholder="Fecha" data-input>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <input name="obs" id="obs" type="text" class="form-control" placeholder="Observaciones"  >
                                </div>
                            </div>
                            <button type="submit" class="btn btn-primary submit mt-3">Registrar Plan</button>
                        </form>
