          ...
          <div class="card">
              <div class="card-body">
                ...
                <h6 class="card-title mb-1">Asignación del Docente a la comision</h6>
                      ...
                      <form method="POST" id="asignacion" action="{{route('admin.asignacions.update', $asignacion)}}" enctype="multipart/form-data">
                          @csrf 
                          @method('PUT')
                          <div class="row">
                              <div class="col-sm-4">
                                  <div class="mb-3">
                                      ...
                                      <select name="user_id" id="user_id" class="form-control" aria-label="Default select example" >
                                        <option value="{{($asignacion->user->id)}}">{{$asignacion->user->name}}</option> 
                                      </select>
                                  </div>
                              </div>
                              <div class="col-sm-4">
                                <div class="mb-3">
                                    ...
                                    <select name="comision_id" id="comision_id" class="form-control" aria-label="Default select example">
                                        <option value="{{($asignacion->comision->id)}}">{{$asignacion->comision->name}}</option>  
                              ...
                              <div class="col-sm-4">
                                  <div class="mb-3 text-center">
                                      ...
                                      <div class="input-group flatpickr" id="flatpickr-date">
                                          <input name="fecha" id="fecha" type="text" class="form-control" placeholder="Fecha" data-input value="{{old('name', $asignacion->fecha)}}" >
                          ...
                          <div class="row">
                              <div class="col-sm-12">
                                  ...
                                  <textarea class="form-control" name="tarea" id="tinymceExample" rows="15">{{old('name', $asignacion->tarea)}}</textarea>
                              </div>
                          </div>
                          <button type="submit" class="btn btn-primary submit mt-3">Actualizar Asignacion del Docente</button>
                      </form>
