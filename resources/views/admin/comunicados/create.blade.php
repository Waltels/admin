            ...
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title mb-1">datos del comunicado</h6>
                        ...
                        <form method="POST" id="comunicados" action="{{route('admin.comunicados.store')}}" enctype="multipart/form-data">
                            @csrf 
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <textarea class="form-control" name="content" id="tinymceExample" rows="15"></textarea>
                                </div>
                            </div>
